package com.example.joshuaqualls.androidproficiency3;
...
import com.example.joshuaqualls.androidproficiency3.databinding.ActivityMainBinding;
import java.net.URL;
...
public class MainActivity extends AppCompatActivity{
    ...
    protected void onCreate(Bundle savedInstanceState){
        ...
        binding.APIButton.setOnClickListener(new View.OnClickListener(){
            public void onClick(View v){
                try {
                    getText();
                }
                catch(Exception e) {
                    binding.APITextView.setText("URL Exception!");
                }
            }
    ...
    private void getText() throws UnsupportedEncodingException {
        String team = "48";
        String currentValue = binding.infoTextView.getText().toString();

        String data = URLEncoder.encode("team", "UTF-8") + "=" + URLEncoder.encode(team, "UTF-8");

        data += "&" + URLEncoder.encode("number", "UTF-8") + "=" + URLEncoder.encode(currentValue, "UTF-8");
        String text = "";
        BufferedReader reader = null;

        try{
            URL url = new URL("http://cgi.sice.indiana.edu/~examples/info-i494/api/index.php/magic-number");
        ...
        binding.APITextView.setText(text);
    }
}
